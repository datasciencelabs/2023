...
The __data.table__ package is very powerful and the best package for dealing with large datasets in R. In this course we use the__tidyverse__ because it is easier for begginers. But if you plan to analyze large datasets in the future we highly recommend learning this package.
...
## Optional exercises (not in the midterm)
