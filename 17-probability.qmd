...
$$
\sigma^2 = \mbox{Var}[X_i] = \mbox{E}[(X_i-\mu)^2]
$$
Let's check with a Monte Carlo simualtion:
...
$$
\mbox{Var}[S_n] =\mbox{Var}[\sum_{i=1}^n X_i] =  \mbox{Var}[\sum_{i=1}^n X_i] = n \sigma^2
$$
...
with $n=500,000$ and $\mbox{\Pr}(X_i=1) = 0.000001$.
...
Rember the formula for sum of variance is actually:
$$
