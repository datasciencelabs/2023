...
* We can think of all predictors $(x_{i,1}, \dots, x_{i,n})$ for all observations $i=1,\dots,n$ as $n$ points. 
...
* In the case of the handwritten digits, we can think of the predictor space as any point $(x_{1}, \dots, x_{n})$ as long as each entry $x_i, i = 1, \dots, n$ is between 0 and 255.
