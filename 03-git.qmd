...
to move file to the local repository. This file is now _tracked_ and a copy of this version is kept going forward... this is like adding `V1` to your filename.

You can commit specific files by adding it at the end
...
Because we defined main above and origin defaults to current local branch, we usually can just type
